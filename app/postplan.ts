...
const greeneryPreparingSocialCopy = `Zeleň v obci není jen otázka výsadby. Je to práce s místem, vodou, stínem i dlouhodobou údržbou.

V Přezleticích ji proto řešíme postupně: u průtahových komunikací, v rekonstruovaných ulicích, u podzemních kontejnerů i u komunitního centra. Někde dává smysl strom, jinde trvalky a keře, jinde hlavně dobrý plán péče.

Důležité je, aby zeleň nebyla dekorace, ale funkční součást obce. Podrobnější článek o tom, jak o veřejnou zeleň pečujeme a co připravujeme dál, právě chystáme.`;
...
export const initialPosts: SocialPost[] = [
  ...
  { id: 140, date: "2026-09-02", title: "Hotová práce · Veřejná zeleň · Jak se staráme o Přezletice", contentType: "completed", pillar: "Práce", format: "Carousel", status: "Copy", author: "Copy + Grafika", graphic: "Fotky přiřazeny · bez odkazu na článek", copy: "Hotovo", approval: "Ke schválení", articleSlug: "zelen-v-prezleticich", websiteItemId: "article-zelen-v-prezleticich", primaryImage: "/images/projects/zelen-mistni-komunikace.webp", galleryImages: ["/images/projects/zelen-prutahove-komunikace.webp", "/images/projects/zelen-podzemni-kontejnery.webp", "/images/projects/hruskove-aleje-a-dalsi-zelen.webp", "/images/projects/dalsi-lokalni-zelen.webp", "/images/projects/komunitni-centrum-zlatak.webp"], draftLink: "content/articles/zelen-v-prezleticich.md", socialCopy: greeneryPreparingSocialCopy, facebookCopy: greeneryPreparingSocialCopy, instagramCopy: greeneryPreparingSocialCopy, carouselOutline: ["Zeleň jako funkční součást obce", "Stromy, stín a práce s vodou", "Výsadba podél komunikací", "Zeleň v rekonstruovaných ulicích", "Úpravy u technických míst a komunitního centra", "Dobrá péče nekončí výsadbou"], altText: "Fotografický carousel ukazující péči o veřejnou zeleň na několika místech v Přezleticích.", cta: "Podrobnější článek o péči o zeleň právě připravujeme.", assetStatus: "Fotografie přiřazeny; grafika nesmí obsahovat URL ani odkazovou výzvu na článek.", contentSummary: "Carousel o zeleni jako systému péče o ulice, technická místa a veřejný prostor; v doprovodném textu oznamuje připravovaný podrobnější článek.", productionNote: "Publikovat 2. 9. V grafice nepoužívat URL, tlačítko, QR kód ani formulaci „přečtěte si článek“. Informaci, že podrobnější článek připravujeme, uvést pouze v textu postu. Před publikací dokončit faktickou kontrolu." },
