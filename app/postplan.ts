...
👉 Také vám přiblížíme naše plány a jednotlivé části programu, kterými pokračujeme v dosavadní práci.
...
- sousedské a mezigenerační vztahy,
...
- kulturu, sport, komunitní život a sousedské vztahy.

Jednotlivým tématům se budeme v dalších týdnech věnovat do hloubky. Vždy konkrétně, lidsky a s vazbou na práci, kterou už v Přezleticích děláme.`;
...
const logoOriginSocialCopy = `Jak vzniklo logo Přezleťáků?

Hledali jsme symbol, který nebude jen ozdobou kampaně, ale bude vystihovat způsob, jakým chceme pro Přezletice pracovat. Proto vznikla podaná ruka — jednoduché gesto spolupráce, důvěry a sousedství.

Modrá v naší identitě znamená klid, odpovědnost a důvěru. Žlutá přináší energii, otevřenost a chuť posouvat věci dopředu. Společně tvoří přehledný vizuální systém pro lidi, projekty, program i vysvětlování složitějších témat.

V carouselu vám ukážeme, jak se tato myšlenka proměnila v logo a celou identitu Přezleťáků 2026.`;

const greeneryPreparingSocialCopy = `Co pro nás znamená péče o zeleň v Přezleticích? Není to jen otázka výsadby. Je to práce s místem, vodou, stínem i dlouhodobou údržbou.

Patří sem stromy a aleje, zeleň u průtahových komunikací, výsadby v rekonstruovaných ulicích i okolí podzemních kontejnerů a komunitního centra. Někde dává smysl strom, jinde trvalky a keře, jinde hlavně dobrý plán péče.

Důležité je, aby zeleň nebyla pouze dekorací, ale funkční součástí obce, která pomáhá i během horkých dnů. Podrobnější článek o tom, co pro nás péče o veřejnou zeleň znamená a co připravujeme dál, právě chystáme.`;
...
const newWebsiteSocialCopy = `Máme nový web! 💙💛

Na jednom místě teď najdete, kdo jsou Přezleťáci, co jsme v Přezleticích udělali, na čem pracujeme a jaké máme plány pro další roky.

Chceme, aby naše práce i další kroky byly srozumitelné a snadno dohledatelné. Proto na webu najdete náš tým, konkrétní projekty, program i články, ve kterých podrobněji vysvětlujeme důležitá témata z obce.

Podívejte se na nový web:
🌐 https://prezletaci2011.cz

Budeme rádi, když nám dáte vědět, co vás zajímá nebo co byste na webu chtěli najít.`;

const newWebsiteInstagramCopy = `Máme nový web! 💙💛

Kdo jsme, co jsme v Přezleticích udělali, na čem pracujeme a jaké máme plány – teď přehledně na jednom místě.

Najdete tam náš tým, projekty, program i články k důležitým tématům z obce.

🌐 prezletaci2011.cz

Podívejte se a dejte nám vědět, co vás zajímá.`;

const curatedPostMedia: Record<number, Pick<SocialPost, "primaryImage" | "galleryImages">> = {
  115: { primaryImage: "/images/projects/rozsireni-kapacity-svazkove-skoly.webp", galleryImages: ["/images/projects/druhy-pavilon-ms.webp"] },
  121: { primaryImage: "/images/articles/uzemni-plan-2001.webp", galleryImages: ["/images/articles/uzemni-plan-etapizace-2011.webp"] },
  123: { primaryImage: "/images/articles/uzemni-plan-etapizace-2011.webp", galleryImages: ["/images/articles/uzemni-plan-2001.webp"] },
  134: { primaryImage: "/images/social/logo-predstaveni-prezletaku.svg", galleryImages: ["/images/brand/prezletaci-symbol-blue.png"] },
  140: { primaryImage: "/images/projects/zelen-mistni-komunikace.webp", galleryImages: ["/images/projects/zelen-prutahove-komunikace.webp"] },
  141: { primaryImage: "/images/articles/nova-radnice-studie-exterier.webp", galleryImages: ["/images/articles/nova-radnice-studie-situace.webp"] },
  144: { primaryImage: "/images/articles/uzemni-plan-etapizace-2011.webp", galleryImages: ["/images/articles/bila-vratka-podminenost-skoly.webp"] },
  145: { primaryImage: "/images/brand/social/prezletaci-social-yellow.png", galleryImages: [] },
  146: { primaryImage: "/images/projects/elektronicka-uredni-deska.webp", galleryImages: [] },
  148: { primaryImage: "/images/projects/rozsireni-kapacity-svazkove-skoly.webp", galleryImages: ["/images/projects/druhy-pavilon-ms.webp"] },
};

const curatePostMedia = (post: SocialPost): SocialPost => {
  const curated = curatedPostMedia[post.id] ? { ...post, ...curatedPostMedia[post.id] } : post;
  if (!curated.galleryImages) return curated;
  const galleryLimit = curated.primaryImage ? 1 : 2;
  return { ...curated, galleryImages: curated.galleryImages.slice(0, galleryLimit) };
};
...
export const initialPosts: SocialPost[] = [
  ...
  { id: 103, date: "2026-09-04", title: "Lidé · Web · Máme nový web", contentType: "people", pillar: "Lidé", format: "Post", status: "Ke schválení", author: "Copy + Grafika", graphic: "Připraveno", copy: "Hotovo", approval: "Ke schválení", subjectType: "channel", primaryImage: "/images/social/post-novy-web.png", socialCopy: newWebsiteSocialCopy, facebookCopy: newWebsiteSocialCopy, instagramCopy: newWebsiteInstagramCopy, hashtags: ["#prezletaci", "#prezletice", "#novyweb", "#volby2026", "#naspribeh"], altText: "Grafika Přezleťáků s textem „Máme nový web“, notebookem s náhledem webu a adresou prezletaci2011.cz.", futureWebPath: "https://prezletaci2011.cz", cta: "Navštivte nový web: prezletaci2011.cz", assetStatus: "Finální grafika připravena: public/images/social/post-novy-web.png", contentSummary: "Oznamovací příspěvek představuje nový web Přezleťáků jako jedno místo pro tým, odvedenou práci, rozpracované projekty, program a vysvětlující články.", productionNote: "Publikovat 4. 9. s dodanou portrétní grafikou. Pro Facebook použít plnou verzi textu, pro Instagram kratší variantu; zachovat adresu prezletaci2011.cz." },
  ...
  { id: 105, date: "2026-09-15", title: "Hotová práce · Svazková škola · Co se povedlo", contentType: "completed", pillar: "Práce", format: "Post", status: "Námět", author: "Obsahový tým", graphic: "Čeká", copy: "Čeká", approval: "Čeká", contentSummary: "Výsledek dosavadní práce na vzniku a fungování svazkové školy a jídelny.", productionNote: "Přesunuto z 2. 9. kvůli prioritnímu postu o zeleni. Oddělit již hotovou práci od navazujícího rozšiřování kapacity; použít ověřenou fotografii školy." },
  { id: 106, date: "2026-09-10", title: "Vysvětlujeme · Škola v datech · Kapacita a další krok", contentType: "evidence", pillar: "Vysvětlování", format: "Post", status: "Námět", author: "Copy", graphic: "Čeká", copy: "Čeká", approval: "Čeká", articleSlug: "kapacita-skol-a-skolek", websiteItemId: "article-kapacita-skol-a-skolek", subjectType: "article", projectId: 7, contentSummary: "Datové vysvětlení současné kapacity svazkové školy a připravovaného rozšíření.", productionNote: "Použít pouze potvrzená kapacitní data, uvést zdroj a vizuálně oddělit současný stav od plánovaného kroku." },
  ...
  { id: 109, date: "2026-09-19", title: "Rozdělané věci · Relaxační centrum u rybníka · Kde právě jsme", contentType: "progress", pillar: "Rozdělané", format: "Post", status: "Námět", author: "Obsahový tým", graphic: "Čeká", copy: "Čeká", approval: "Čeká", projectId: 6, contentSummary: "Aktuální stav sportovně-relaxačního centra u rybníka a zbývající etapy.", productionNote: "Přesunuto z 3. 9., který zůstává volným rezervním dnem. Použít aktuální projektovou fotografii a jasně vypsat dokončené části a nejbližší další krok." },
  ...
  { id: 134, date: "2026-09-01", title: "Lidé · Identita · Jak vzniklo logo Přezleťáků", contentType: "people", pillar: "Lidé", format: "Carousel", status: "Copy", author: "Copy + Grafika + Media", graphic: "Připraveno", copy: "Hotovo", approval: "Ke schválení", subjectType: "brand", primaryImage: "/images/social/logo-predstaveni-prezletaku.svg", galleryImages: ["/images/brand/social/prezletaci-social-blue.png", "/images/brand/social/prezletaci-social-yellow.png", "/images/brand/prezletaci-symbol-blue.png", "/images/brand/prezletaci-lockup-blue.png"], draftLink: "content/social/program-a-logo-posty.md", socialCopy: logoOriginSocialCopy, facebookCopy: logoOriginSocialCopy, instagramCopy: logoOriginSocialCopy, carouselOutline: ["Jak vzniklo logo Přezleťáků?", "Hledali jsme symbol spolupráce, důvěry a sousedství.", "Podaná ruka se stala hlavním motivem.", "Modrá: klid, odpovědnost a důvěra.", "Žlutá: energie, otevřenost a pohyb.", "Z motivu vznikl systém pro lidi, projekty, program i vysvětlování.", "Přezleťáci 2026: přehledně a společně."], hashtags: ["#prezletaci", "#prezletice", "#volby2026", "#logo", "#identita", "#spoluprace"], altText: "Carousel v modré a žluté identitě vysvětlující vznik loga Přezleťáků se symbolem podané ruky.", cta: "Prolistujte si, jak vzniklo logo a vizuální identita Přezleťáků 2026.", assetStatus: "Carousel připraven k publikaci podle dodané grafiky.", promotion: "Po publikaci zkusit boostnout; před spuštěním potvrdit cílení, rozpočet a délku podpory.", contentSummary: "Carousel vysvětluje vznik loga Přezleťáků: podanou ruku jako symbol spolupráce a význam modré a žluté v celé kampani.", productionNote: "Publikovat 1. 9. místo opakovaného postu o celém týmu, který už vyšel 19. 8. Po publikaci připravit boost a zkontrolovat finální cílení, rozpočet a délku kampaně." },
  ...
  { id: 140, date: "2026-09-02", title: "Hotová práce · Veřejná zeleň · Co pro nás znamená péče o zeleň", contentType: "completed", pillar: "Práce", format: "Carousel", status: "Copy", author: "Copy + Grafika", graphic: "Fotky přiřazeny · bez odkazu na článek", copy: "Hotovo", approval: "Ke schválení", articleSlug: "zelen-v-prezleticich", websiteItemId: "article-zelen-v-prezleticich", primaryImage: "/images/projects/zelen-mistni-komunikace.webp", galleryImages: ["/images/projects/zelen-prutahove-komunikace.webp", "/images/projects/zelen-podzemni-kontejnery.webp", "/images/projects/hruskove-aleje-a-dalsi-zelen.webp", "/images/projects/dalsi-lokalni-zelen.webp", "/images/projects/komunitni-centrum-zlatak.webp"], draftLink: "content/articles/zelen-v-prezleticich.md", socialCopy: greeneryPreparingSocialCopy, facebookCopy: greeneryPreparingSocialCopy, instagramCopy: greeneryPreparingSocialCopy, carouselOutline: ["Co pro nás znamená péče o zeleň?", "Stromy a aleje přinášejí stín a propojují obec", "Zeleň u průtahových komunikací", "Výsadby v rekonstruovaných ulicích", "Úpravy u technických míst a komunitního centra", "Dobrá péče nekončí výsadbou"], altText: "Fotografický carousel ukazující stromy, aleje a péči o veřejnou zeleň na několika místech v Přezleticích.", cta: "Podrobnější článek o tom, co pro nás péče o zeleň znamená, právě připravujeme.", assetStatus: "Fotografie přiřazeny; grafika nesmí obsahovat URL ani odkazovou výzvu na článek.", contentSummary: "Carousel vysvětluje péči o zeleň jako práci se stromy, alejemi, ulicemi, technickými místy a horkými dny; v doprovodném textu oznamuje připravovaný podrobnější článek.", productionNote: "Publikovat 2. 9. V grafice nepoužívat URL, tlačítko, QR kód ani formulaci „přečtěte si článek“. Informaci, že podrobnější článek připravujeme, uvést pouze v textu postu. Před publikací dokončit faktickou kontrolu." },
  { id: 141, date: "2026-09-25", title: "Plány · Nová radnice · Centrum obce", contentType: "future", pillar: "Plány", format: "Carousel", status: "Copy", author: "Copy + Grafika", graphic: "Fotky přiřazeny", copy: "Hotovo", approval: "Ke schválení", articleSlug: "nova-radnice-centrum-obce", websiteItemId: "article-nova-radnice-centrum-obce", projectId: 16, primaryImage: "/images/articles/nova-radnice-studie-exterier.webp", galleryImages: ["/images/articles/nova-radnice-studie-situace.webp", "/images/articles/nova-radnice-studie-pruchod.webp", "/images/articles/nova-radnice-studie-rynek.webp"], draftLink: "content/articles/nova-radnice-centrum-obce.md", contentSummary: "Publikovatelný článek a carousel o nové radnici jako součásti budoucího centra obce.", productionNote: "Použít vizualizace z aktualizované studie obecního úřadu z února 2025 a jasně je označit jako návrh." },
  { id: 144, date: "2026-09-23", title: "Vysvětlujeme · Development · Bílá vrátka a dva projekty v území", contentType: "evidence", pillar: "Vysvětlování", format: "Carousel", status: "Copy", author: "Copy + Fact-check", graphic: "Brand podklad", copy: "Hotovo", approval: "Ke schválení", articleSlug: "bila-vratka-pozemek-skola", websiteItemId: "article-bila-vratka-pozemek-skola", subjectType: "article", primaryImage: "/images/brand/social/prezletaci-social-blue.png", galleryImages: ["/images/projects/rozsireni-kapacity-svazkove-skoly.webp", "/images/projects/elektronicka-uredni-deska.webp"], draftLink: "content/articles/bila-vratka-pozemek-skola.md", socialCopy: "Bílá vrátka nejsou celý příběh. Na západní straně Přezletic se připravovaly dva navazující developerské projekty a současně se řešil pozemek pro školu. Veřejné zápisy ukazují debatu o vymezení pozemků, nabytí spoluvlastnického podílu i další kroky kolem školní kapacity. Připravili jsme proto časovou osu, která odděluje oba projekty a propojuje jejich společné dopady na školu a infrastrukturu.", carouselOutline: ["Bílá vrátka nejsou celý příběh.", "V západním území se připravovaly dva developerské projekty.", "Rok 2011: podíl na pozemcích ještě nebyl samostatným školním pozemkem.", "Rok 2014: obec řešila malou školní kapacitu i další pozemky v území.", "Rok 2015: svazek obcí a příprava školy změnily měřítko řešení.", "Společné dopady: škola, doprava, sítě a veřejný prostor.", "Každý bod časové osy musí mít veřejný zdroj."], cta: "Projděte si časovou osu dvou developerských projektů a jejich souvislost se školou.", contentSummary: "Článek a carousel vysvětlují, že Bílá vrátka jsou součástí širší historie dvou navazujících developerských projektů, pozemků pro školu a veřejné infrastruktury.", productionNote: "Před publikací doplnit veřejný doklad k oddělení školního pozemku, ověřit přesné hranice a názvy obou projektů a provést právní kontrolu. Důvěrnou smlouvu nezveřejňovat." },
...
const version8DefaultTitles: Record<number, string> = {
  ...
  144: "Bílá vrátka v kontextu dvou developerských projektů", 145: "Hasiči v Přezleticích", 146: "Jak ověřujeme tvrzení o historii obce", 147: "Volný den / rezerva", 148: "Proč musí spolupráce obcí pokračovat",
};
...
const septemberPlanUpgradePostIds = new Set([105, 109, 134, 140]);
const greeneryFeedbackPostIds = new Set([140]);
...
const articleLinkUpgradePostIds = new Set([106, 137]);
...
export function mergePostsWithPlan(savedPosts: SocialPost[], savedVersion = 4) {
  ...
  for (const post of preserved) {
    ...
    const migrated = {
      ...canonical,
      ...post,
      contentType: refreshCanonicalUpdate ? canonical.contentType : post.contentType ?? canonical.contentType,
      pillar: refreshCanonicalUpdate ? canonical.pillar : post.pillar,
      format: refreshCanonicalUpdate ? canonical.format : post.format,
      ...
      subjectType: refreshCanonicalUpdate || refreshArticleLink ? canonical.subjectType : post.subjectType ?? canonical.subjectType,
      articleSlug: refreshCanonicalUpdate || refreshArticleLink ? canonical.articleSlug : post.articleSlug ?? canonical.articleSlug,
      websiteItemId: refreshCanonicalUpdate || refreshArticleLink ? canonical.websiteItemId : post.websiteItemId ?? canonical.websiteItemId,
      primaryImage: refreshCanonicalUpdate || refreshMediaAudit ? canonical.primaryImage : post.primaryImage ?? canonical.primaryImage,
      galleryImages: refreshCanonicalUpdate || refreshMediaAudit ? canonical.galleryImages : post.galleryImages ?? canonical.galleryImages,
      draftLink: refreshCanonicalUpdate ? canonical.draftLink : post.draftLink ?? canonical.draftLink,
      socialCopy: refreshCanonicalUpdate || refreshGreeneryFeedback ? canonical.socialCopy : post.socialCopy ?? canonical.socialCopy,
      facebookCopy: refreshCanonicalUpdate || refreshGreeneryFeedback ? canonical.facebookCopy : post.facebookCopy ?? canonical.facebookCopy,
      instagramCopy: refreshCanonicalUpdate || refreshGreeneryFeedback ? canonical.instagramCopy : post.instagramCopy ?? canonical.instagramCopy,
      carouselOutline: refreshCanonicalUpdate || refreshGreeneryFeedback ? canonical.carouselOutline : post.carouselOutline ?? canonical.carouselOutline,
      hashtags: refreshCanonicalUpdate ? canonical.hashtags : post.hashtags ?? canonical.hashtags,
      altText: refreshCanonicalUpdate || refreshGreeneryFeedback ? canonical.altText : post.altText ?? canonical.altText,
