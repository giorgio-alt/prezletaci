...
export const initialPosts: SocialPost[] = [
  ...
  { id: 147, date: "2026-09-03", title: "Rezerva · Volný den · Obsah podle aktuální situace", contentType: "explain", pillar: "Vysvětlování", format: "Post", status: "Námět", author: "Obsahový tým", graphic: "Čeká", copy: "Čeká", approval: "Čeká", subjectType: "general", assetStatus: "Bez povinného výstupu", contentSummary: "Volný den v publikačním plánu. Post se připraví pouze tehdy, pokud se objeví aktuální a smysluplné téma.", productionNote: "Primární varianta je 3. 9. nepublikovat. Rezervu použít jen pro aktuální obsah, který vznikne v průběhu kampaně a projde rychlou kontrolou copy, grafiky a schválení." },
